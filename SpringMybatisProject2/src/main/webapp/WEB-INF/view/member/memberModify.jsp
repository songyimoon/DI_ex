...
<tr>
	<td>우편번호</td>
	<td><input type="text" name="postNumber" id="sample4_postcode" value="${lists[0].postNumber }" readonly="readonly"></td>
</tr>

<tr>
	<td>주소</td>
	<td><input type="text" name="memAddress" id="sample4_roadAddress" value="${lists[0].memAddress }" size="30" readonly="readonly">
...
<tr>
	<td>생년월일</td>
	<td><fmt:formatDate value="${lists[0].memBirth }" pattern="yyyy-MM-dd" type="date"/></td>
</tr>
